                ...
                <div class="col-xl-8 col-lg-8">
                    <div class="container mt-5">
                        <div class="card mx-auto" style="">
                            <img src="{{ asset($university->featured_image_url) }} " class="card-img-top" alt="University Image">
                        ...
                        <div class="coursearea sp_top_100 sp_bottom_100">
                            <div class="container">
                                            ...
                                            <div class="course__icon">
                                                <ul class="nav property__team__tap" id="myTab" role="tablist">
                                                    ...
                                                    <li class="nav-item" role="presentation">
                                                        <a href="#degree_{{ $degreeId }}" class="single__tab__link @if ($loop->first) active @endif" data-bs-toggle="tab" role="tab">
                                ...
                                <div class="tab-content tab__content__wrapper" id="myTabContent">
                                    @foreach ($degrees as $degreeId => $programs)
                                    <div class="tab-pane fade @if ($loop->first) show active @endif" id="degree_{{ $degreeId }}" role="tabpanel">
